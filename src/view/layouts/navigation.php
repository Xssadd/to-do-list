        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="<?= \App\Core\Router::url('task.list') ?>" aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">To-Do List</a>
            ...
            <?php else: ?>
                <div class="text-white">
                    ...
                    <a class="hover:text-gray-400" href="/register">Registration</a>
                </div>
            <?php endif; ?>
